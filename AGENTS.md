...
- Do not upgrade, reinstall, or replace tools unless the user explicitly asks.
...
This folder is for the MTA 2026 Semester B DevOps final project. The project is 50% of the final grade and must be submitted by 2026-06-15 at midnight. Work must satisfy the assignment contract, not just look like a working demo.
...
- When fixing or adding project files, preserve evidence artifacts unless the user explicitly asks for cleanup.
