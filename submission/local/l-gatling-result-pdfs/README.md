...
- Source: Jenkins local build `#260`, archived from `output/gatling/`

The three PDFs were regenerated by build `#260` and validated as readable PDF files. Terminal/CMD screenshots are packaged separately under item `k`.
