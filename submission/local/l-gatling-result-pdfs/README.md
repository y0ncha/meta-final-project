...
- Source: Jenkins local build `#248`, archived from `output/gatling/`

The three PDFs were regenerated by build `#248` and validated as readable PDF files. Terminal/CMD screenshots are packaged separately under item `k`.
