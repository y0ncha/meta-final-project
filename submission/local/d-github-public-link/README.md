...
- Manual check needed: open the URL without authentication before sending

The link file is packaged. Public accessibility still needs a final browser check.
