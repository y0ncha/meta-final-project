...
The public 5-minute stress test used the EC2 Tomcat URL and ramped from `5` to `50` virtual users over about `300` seconds. The run completed with `15368` requests, `15368 OK`, and `0 KO`.
