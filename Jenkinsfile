pipeline {
  ...
  parameters {
    ...
    string(name: 'GATLING_MAX_START_USERS', defaultValue: '0', description: 'First virtual-user level for targeted Gatling max-limit confirmation')
    string(name: 'GATLING_MAX_STEP_USERS', defaultValue: '25', description: 'Virtual-user increase between Gatling max-limit levels')
    ...
    string(name: 'GATLING_MAX_END_USERS', defaultValue: '550', description: 'Highest virtual-user level to test before reporting a lower bound')
