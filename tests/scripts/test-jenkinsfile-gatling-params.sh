...
assert_contains "description: 'Last users/sec level to test before reporting a lower bound'"
...
assert_contains 'GATLING_MAX_END_USERS_PER_SEC = "${params.GATLING_MAX_END_USERS_PER_SEC}"'
...
assert_contains '-e GATLING_MAX_START_USERS_PER_SEC=${env.GATLING_MAX_START_USERS_PER_SEC}'
...
assert_contains '-e GATLING_MAX_END_USERS_PER_SEC=${env.GATLING_MAX_END_USERS_PER_SEC}'
