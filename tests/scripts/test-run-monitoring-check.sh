...
APP_BASE_URL="http://example.test/yonatan-csasznik-yoed-halberstam-niv-levin/" \
...
assert_contains "$CURL_ARGS_FILE" 'http://example.test/yonatan-csasznik-yoed-halberstam-niv-levin/'
assert_contains "$OUTPUT_FILE" 'status=up'
assert_contains "$OUTPUT_FILE" 'target=http://example.test/yonatan-csasznik-yoed-halberstam-niv-levin/'
