...
assert_contains 'Checkout</td><td>Jenkins console log</td><td><span class="status status-log">Console log</span>'
...
assert_contains 'Requires <code>RUN_GATLING_MAX_LIMIT=true</code>'
