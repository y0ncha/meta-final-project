...
| TASK-025 | Run `curl -s http://localhost:8080/MeTA/` and confirm the response contains `MeTA`, `About this app`, `nameInput`, and `submitButton`. | ✅ | 2026-06-10 |
...
- **TEST-009**: `curl -s http://localhost:8080/MeTA/` must contain `MeTA`, `About this app`, `nameInput`, and `submitButton`.
